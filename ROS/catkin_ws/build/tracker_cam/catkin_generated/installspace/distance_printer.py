...
class image_converter:
    ...
    def __init__(self):
        ...
        # /xtion/depth_registered/image_raw pr robot
        self.dist_sub = message_filters.Subscriber("/xtion/depth/image", Image)

        self.pose_head = message_filters.Subscriber(
            "/tiago_controller/head_pose", Pose)

        print("synchronizing")
        self.ts = message_filters.ApproximateTimeSynchronizer(
            [self.center, self.dist_sub, self.pose_head], 10, 0.5, allow_headerless=True)
